...
CREATE TABLE students (
  ...
  payment_status VARCHAR(20) NOT NULL DEFAULT 'Paid' CHECK (payment_status IN ('Paid', 'Pending', 'Unpaid', 'Overdue')),
  card_type VARCHAR(30) NOT NULL DEFAULT 'Full Card' CHECK (card_type IN ('Full Card', 'Half Card', 'Free Card')),
